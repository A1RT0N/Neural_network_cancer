...
# Classe modificada para utilizar VGG19 sem pesos pré-treinados
class VGG19Classifier(nn.Module):
    def __init__(self, num_classes=2):
        super(VGG19Classifier, self).__init__()
        # Carregar VGG19 SEM pesos pré-treinados
...
def evaluate_model(model, dataloader, criterion):
    ...
    with torch.no_grad():
        for inputs, labels, paths in dataloader:
            ...
            all_sample_names.extend(paths)  # Guardar os nomes dos arquivos
...
def load_data(data_dir, batch_size=32, input_size=224):
    ...
    # Use os nomes corretos das pastas: 'Training' e 'Test'
    ...
    # Modificar DataLoader para incluir os caminhos das imagens
    dataloaders = {
        x: DataLoader(
            [
...
BATCH_SIZE = 32
INPUT_SIZE = 224  # Geralmente 224x224 para VGG19
NUM_CLASSES = 2
NUM_EPOCHS = 50
...
# Instanciar o modelo com VGG19
model = VGG19Classifier(num_classes=NUM_CLASSES)
