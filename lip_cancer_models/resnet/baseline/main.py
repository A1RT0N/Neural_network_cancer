# https://repositorio.usp.br/item/003141782
...
logging.basicConfig(
    filename='training_output_resnet101_baseline.log',
    level=logging.INFO,
    format='%(asctime)s - %(levelname)s - %(message)s'
)

# Definição da arquitetura ResNet-101 com ajustes para classificação
...
def load_data(data_dir, batch_size=32, input_size=224):  # ResNet-101 usa 224x224
    data_transforms = {
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                torch.save(model.state_dict(), 'best_resnet101_baseline.pth')
...
BATCH_SIZE = 32
INPUT_SIZE = 224  # ResNet-101 usa 224x224
NUM_CLASSES = 2
NUM_EPOCHS = 50
...
# Instanciar o modelo
model = ResNet101Classifier(num_classes=NUM_CLASSES)
