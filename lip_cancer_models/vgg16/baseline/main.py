...
class VGG16Classifier(nn.Module):
    def __init__(self, num_classes=2, freeze_backbone=True, weights_path=None):
        super(VGG16Classifier, self).__init__()
        
        # Inicializar o modelo VGG16 sem pesos
...
def main():
    ...
    # Instanciar o modelo com pesos pré-treinados personalizados
    model = VGG16Classifier(
        num_classes=NUM_CLASSES, 
        freeze_backbone=True,
        weights_path=PRETRAINED_WEIGHTS_PATH
    )
    logging.info(f"Modelo VGG16 com pesos personalizados de {PRETRAINED_WEIGHTS_PATH} carregado")
    ...
    # Treinar o modelo
    logging.info(f"Iniciando treinamento com modelo VGG16 personalizado por {NUM_EPOCHS} épocas")
    ...
    }, 'final_vgg16_custom_model.pth')
    
    logging.info("Treinamento com pesos personalizados concluído e modelo final salvo!")
